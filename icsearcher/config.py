...
class ToolConfig:
    ...
    def _load_yaml_config(self):
        """Load YAML config, falling back to an empty dict on error.

        ``data/config.yaml`` is committed and is the single source of
        configuration; it always exists after a fresh clone. If it is missing
        or malformed, every field falls back to its hardcoded default.
        """
